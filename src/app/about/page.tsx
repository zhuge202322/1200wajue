            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div className="aspect-[4/5] bg-surface-dim overflow-hidden shadow-md group">
                  <img src="/images/banner/slide6.jpg" alt="Factory Overview" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
                <div className="aspect-square bg-surface-dim overflow-hidden shadow-md group">
                  <img src="/images/about/employees.jpg" alt="Our Team" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
              </div>
              <div className="space-y-4 pt-8">
                <div className="aspect-square bg-surface-dim overflow-hidden shadow-md group">
                  <img src="/images/banner/slide4.jpg" alt="Manufacturing" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
                <div className="aspect-[4/5] bg-surface-dim overflow-hidden shadow-md group">
                  <img src="/images/banner/slide3.jpg" alt="Global Shipping" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
                </div>
              </div>
            </div>
          </div>
